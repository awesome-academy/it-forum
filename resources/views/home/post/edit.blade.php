...
@section('title', __('page.post.edit'))
@section('link-header')
...
<div id="mainbar" class="ask-mainbar box-border">
    {!! Form::open(['id' => 'post-form', 'route' => ['home.post.postEdit', $post->id]]) !!}
        <div id="question-form">
            ...
            <div class="js-wz-element" id="post-title"> 
                <div class="form-item ask-title">
                    ...
                    {!! Form::text('title', $post->title, ['id' => 'title', 'placeholder' => 'Your title', 'autocomplete' => 'off', 'class' => 's-input js-ask-title h100 mt0 ask-title-field']) !!}
            ...
            <div class="js-wz-element" id="question-only-section">
                <div class="form-submit cbt grid gsx gs4 p0 mt32">
                    ...
                    <a href="{{ route('home.index') }}" class="grid--cell s-btn s-btn__danger discard-question">{{ __('page.post.cancel') }}</a>
                </div>
            </div>
        </div>
    {!! Form::close() !!}
