            ...
            <ul>
                <li class="category">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('home.user.follower', $id) }}" class="youarehere">
    ...
    <div id="mainbar">
        ...
        <div id="user-browser">
            <div class="grid-layout">
                <!-- posts section -->
                @forelse ($allFollowers as $key => $follower)
                    @php
                        $user = $follower->user
                    @endphp
                ...
                @empty
                    <div class="question-summary">
                        <div class="summary">
                            <h3>
                                {{ __('page.followerEmpty') }}
                            </h3>
                        </div>
                    </div>
                @endforelse
                <!-- end post section -->
                @include('home.layout.pagination', ['paginator' => $allFollowers])
            </div>
        </div>
    </div>
</div>
