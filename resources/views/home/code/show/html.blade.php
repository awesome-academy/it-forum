...
{!! Form::open(['id' => 'snippetForm']) !!}
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs" id="nav-tabs">
            ...
            <li><a href="#result" id="btnResult" data-toggle="tab" onclick="funcChangeTab('result')">{{ __('page.code.result') }}</a></li>
            ...
            <span class="pull-right padding10px">{{ route('home.code.embedded',$code->codename) }}</span>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane" id="result">
                ...
                <iframe id="iframeResult" class="height300px" src="{{ route('home.code.execute', $code->codename) }}"
...
<script>
    ...
    cssEditor.setSize(null, 500);
    javascriptEditor.setSize(null, 500);
